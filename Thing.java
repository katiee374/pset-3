 ...
 * constructor. 
 * For the toString method, write it so that it returns name and description 
 * in Thing,  and modify the other classes to override Thing's toString(). 
 * Modify the Room,  Actor, and Treasure classes to extend Thing, and remove 
 * any redundant code.
 * 
...
{
    /*
     * TODO: Create instance variables from Room, Actor, and Treasure here
     */
    ...
    /*
     * TODO: Put methods that Room, Treasure, and Actor have in common here
     */
